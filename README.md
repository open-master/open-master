...
Open Master 是一个开源的 AI 导师助手平台，内置产品导师、科学导师、创意导师等默认角色，也支持你自定义角色的人格、知识和音色。当前 `v0.1.0` 首发版本聚焦于 macOS Apple Silicon 桌面客户端，提供一套本地优先、可持续积累上下文与知识的 AI 工作台体验。
...
- [MiniMax](https://platform.minimaxi.com/) — 语音合成
