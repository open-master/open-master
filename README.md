...
> 人类群星闪耀时，那些改变世界的头脑从未真正远去。
>
> Open Master，让你与伟大头脑对话。

Open Master 是一个开源的 AI 导师助手平台，内置产品导师、科学导师、创意导师等默认角色，也支持你自定义角色的人格、知识和音色。当前 `v0.1.2` 版本聚焦于 macOS Apple Silicon 桌面客户端，提供一套本地优先、可持续积累上下文与知识的 AI 工作台体验。
...
- 支持创建和编辑自定义角色，配置名称、提示词、开场白、角色知识与音色
- 默认角色提供开箱即用的基础人格与知识包

### 🧩 角色知识（v0.1.2 新增）

- 自定义角色支持填写“角色知识”，可沉淀人物背景、方法论、代表观点与常见表达方式
- 角色知识会接入聊天上下文，帮助模型更稳定地贴近角色设定进行回答
- 角色知识会逐步导入 Graphiti，形成可持续积累的角色知识图谱
...
- **自定义角色知识** — 新增“角色知识”字段，可为自定义角色补充背景、观点、方法论与私有知识摘要
- **自定义角色编辑** — 已创建的自定义角色可继续修改提示词、角色知识等核心配置
- **知识接入链路增强** — 自定义角色知识会进入聊天上下文，并逐步导入 Graphiti 知识图谱
- **桌面客户端更新** — 发布新的 macOS Apple Silicon 客户端安装包
